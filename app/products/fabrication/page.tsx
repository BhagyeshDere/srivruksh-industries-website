...
import { ArrowRight, Shield, Layers, Settings2 } from "lucide-react"
  ...
  return (
    <main className="bg-[#f8fafc] min-h-screen">
                  ...
                  <div className="p-8 md:p-10 bg-gradient-to-t from-slate-50/50 to-transparent relative border-t border-slate-50">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <div className="flex flex-col items-end opacity-20">
                        <Layers size={16} className="text-[#0B2E5B]" />
                        <span className="text-[7px] font-bold uppercase mt-1">ISO</span>
                      </div>
                    </div>
                  </div>
      ...
      <div className="py-10 text-center opacity-[0.05] pointer-events-none">
        <p className="text-8xl font-black tracking-tighter">SRIVRUKSH</p>
      </div>
