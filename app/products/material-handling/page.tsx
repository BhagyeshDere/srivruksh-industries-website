    ...
    <main className="bg-[#f8fafc] min-h-screen">
      ...
      <section className="relative bg-[#0B2E5B] py-32 md:py-48 px-6 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.03] select-none pointer-events-none">
          <h2 className="text-[18vw] font-black tracking-tighter leading-none">LOGISTICS</h2>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#C79A3B]/30 bg-[#C79A3B]/10 backdrop-blur-md mb-8"
          >
            <Truck size={14} className="text-[#C79A3B]" />
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#C79A3B]">Industrial Flow Control</span>
          </motion.div>

          <motion.h1 
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="text-5xl md:text-8xl font-black text-white uppercase tracking-tighter leading-[0.9] text-center mb-6"
          >
            Material <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C79A3B] to-[#f3d693]">Handling</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-slate-300 max-w-2xl text-center text-lg md:text-xl font-light"
          >
                ...
                >
                  ...
                  <div className="absolute top-6 left-6 right-6 flex justify-between items-center z-10">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] font-black text-[#0B2E5B]/40 uppercase tracking-widest">MH-PRO-{index + 301}</span>
                    </div>
                  ...
                  <div className="p-8 md:p-10 bg-gradient-to-t from-slate-50/50 to-transparent relative border-t border-slate-50">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-[#C79A3B] font-black text-[9px] uppercase tracking-[0.3em]">Precision Engineered</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <div className="flex flex-col items-end opacity-20">
                        <Settings2 size={16} className="text-[#0B2E5B]" />
                        <span className="text-[7px] font-bold uppercase mt-1">CALIBRATED</span>
                      </div>
                    </div>
                  </div>
      ...
      <div className="py-10 text-center opacity-[0.05] pointer-events-none">
        <p className="text-8xl font-black tracking-tighter uppercase">Operations</p>
      </div>
