...
import { ArrowRight, ShieldCheck, Database, Settings2, Factory, CheckCircle2, Box, Layers, Cpu, Ruler, Activity } from "lucide-react"
...
export default function ProductDetailPage() {
  ...
  if (!product) {
    return (
      <div className="py-40 text-center font-black text-[#0f172a] uppercase tracking-[0.4em] text-xs">
  ...
  return (
    <main className="bg-[#f8fafc] min-h-screen selection:bg-[#C79A3B] selection:text-white overflow-x-hidden">
      ...
      <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 relative overflow-hidden">
        ...
        {/* Engineering Blueprint Watermark */}
      ...
      <section className="bg-slate-900 py-24 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ["Loading Capacity", "Varies per Design"],
              ["Material Grade", "ASTM Standard"],
              ["Coating Systems", "Epoxy / PU Finish"],
              ["Operational Mode", "Manual / Automated"],
            ].map(([title, value], i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -10 }}
              ...
              >
                <div className="flex justify-between items-start mb-10">
                  ...
                  <Settings2 size={14} className="text-white/20 group-hover:text-slate-900 transition-colors" />
                </div>
                <div>
      ...
      <section className="py-24 sm:py-32 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 md:gap-24 items-start">
          ...
          {/* LEFT: INDUSTRY APPLICATIONS */}
          <motion.div>
            <div className="flex items-center gap-4 mb-12">
              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                <Factory className="text-[#0f172a]" size={28} />
              </div>
          ...
          <motion.div className="bg-[#0f172a] p-10 sm:p-16 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-3xl font-black mb-12 uppercase tracking-tighter leading-tight">
              Structural <span className="text-[#C79A3B]">Integrity</span>
            </h3>

            <div className="space-y-8 relative z-10">
              {[
                "Maximum payload stability engineering",
                "Seam-welded for leak-proof containment",
                "Anti-corrosive surface treatment",
                "Custom volumetric scaling options",
                "Safety protocol compliant manufacturing"
              ].map((benefit, i) => (
